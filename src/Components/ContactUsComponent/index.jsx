        ...
        <div className='contact-us'>
            <div class="container my-24 mx-auto md:px-6">
                <div className="title">
                    ...
                    <p>We connect with customers who need to use services from suppliers. We aim to build a community of bird lovers in Vietnam</p>
                </div>

                <section class="mb-10 contact-us-form">
